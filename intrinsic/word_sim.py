...
def loadTestData():
    "loads in human-annotated word similarities"
...
def getSimilarityScoreForWords(w1,w2):
    """for all words pairs in human-annotated data, returns cosine similarity of embedding vectors;
    if either word not in embedding set, returns -1"""
    global embeddings
    #print w1
    #print embeddings
